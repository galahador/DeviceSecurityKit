//
//  ProxyConfigurationChecker.swift
//  DeviceSecurityKit
//
...
internal struct ProxyConfigurationChecker {

    private static let logger = SecurityLogger.security(subsystem: "ProxyConfigurationChecker")
    private static let o = StringObfuscator.shared

    internal static func isProxyConfigured() -> Bool {
